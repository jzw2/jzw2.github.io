...
(function($PS) {
  ...
  var topBar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("top-bar") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(function (v) {
      return new ChangeURL("/home");
  }) ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(function (v) {
  ...
  var homeHtml = Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(shrekUrl) ]), Halogen_HTML_Core.text("welcome to the home page") ]);
  var aboutHtml = Halogen_HTML_Core.text("Go away");
      ...
      var handleAction = function (dictMonadEffect1) {
          return function (v) {
              if (v instanceof ChangeURL) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect1))(Routing_Hash.setHash(v.value0));
              };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body))(function (halogenIO) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matches(myRoute)(function (v) {
              return function (newRoute) {
                  return Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.mkTell(SetRoute.create(newRoute))));
              };
          }));
      });
  }));
  exports["shrekUrl"] = shrekUrl;
  exports["main"] = main;
