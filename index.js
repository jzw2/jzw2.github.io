...
(function($PS) {
  ...
  var component = (function () {
      var render = function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("Increment") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state)) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Increment.value;
          }) ])([ Halogen_HTML_Core.text("docrement") ]) ]);
      };
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 36, column 18 - line 38, column 47): " + [ v.constructor.name ]);
      };
