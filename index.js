...
(function($PS) {
  ...
  var GoProject = (function () {
      function GoProject() {

      };
      GoProject.value = new GoProject();
      return GoProject;
  })();
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              ...
              return GoProject.value;
          }) ])([ Halogen_HTML_Core.text("My Project") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Content"), (function () {
              if (state instanceof Home) {
                  return Halogen_HTML_Core.text("This is my home page");
              };
              if (state instanceof Project) {
                  return Halogen_HTML_Core.text("This is my project  page");
              };
              throw new Error("Failed pattern match at Main (line 39, column 38 - line 41, column 67): " + [ state.constructor.name ]);
          })() ]) ]);
      };
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof GoProject) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  return Project.value;
              });
          };
          throw new Error("Failed pattern match at Main (line 46, column 18 - line 48, column 45): " + [ v.constructor.name ]);
      };
