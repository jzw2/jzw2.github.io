  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              ...
              if (state.value0 instanceof Home) {
                  return Halogen_HTML_Core.text("This is my home page");
              };
              if (state.value0 instanceof About) {
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof GoAbout) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  return new State(About.value);
              });
          };
          if (v instanceof OtherButton) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Main (line 57, column 18 - line 60, column 29): " + [ v.constructor.name ]);
      };
